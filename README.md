...
|---|---|---|---|
| [**ContextOS**](https://github.com/harsh779/contextos-claude-memory) | Windows-first local memory layer for Claude Code — captures project context, decisions, next actions, and restart packs so long-running AI builds can resume with less repeated setup. v0.1.3 shipped. | PowerShell · Python · Claude Code | Open source |
...
Available for **consulting engagements** in analytics strategy, AI-enabled workflows, social intelligence, and data practice builds.
